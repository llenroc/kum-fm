...
namespace Abp.Configuration
{
    ...
    public class DefaultConfigSettingStore : ISettingStore
    {
        ...
        public Task<SettingInfo> GetSettingOrNullAsync(int? tenantId, string userId, string name)
        {
        ...
        /// <inheritdoc/>
        public Task<List<SettingInfo>> GetAllListAsync(int? tenantId, string userId)
        {
