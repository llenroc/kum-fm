...
using Mao.Application.Organizations.Dto;
using System.Linq.Dynamic;
using Mao.Core.Authorization;

namespace Mao.Application.Organizations
{
    [AbpAuthorize(AppPermissions.Pages_Administration_OrganizationUnits)]
    public class OrganizationUnitAppService : MaoAppServiceBase, IOrganizationUnitAppService
    {
