...
using Mao.Application.Authorization.Roles.Dto;
using Mao.Core.Authorization;
using Mao.Core.Authorization.Roles;

namespace Mao.Application.Authorization.Roles
{
    /// <summary>
    /// Application service that is used by 'role management' page.
    /// </summary>
    [AbpAuthorize(AppPermissions.Pages_Administration_Roles)]
    public class RoleAppService : MaoAppServiceBase, IRoleAppService
    {
