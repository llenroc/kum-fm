...
using Mao.Application.Notifications.Dto;

namespace Mao.Application.Notifications
{
    [AbpAuthorize]
    public class NotificationAppService : MaoAppServiceBase, INotificationAppService
    {
